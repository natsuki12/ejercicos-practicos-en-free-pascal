...
begin
    ...
    if ioResult <> 0 then begin		
		{$I-} 
		rewrite(arch);
		{$I+}							//CREA ARCHIVO SOLO SI NO EXISTE Y RETORNA UN BOOLEANDO PARA HACERLE SABER AL PROGRAMA SI LO CREÓ O NO
  ...
  begin
   ...
   begin
       ...
       begin
          ...
          writeln('  Monto                     = ',datosvend[t].monto:0:2);
          writeln('  Pago Online               = ',datosvend[t].pagoo);
          writeln('  Pago En Persona           = ',datosvend[t].pagop);
  ...
  begin
     ...
     begin
      ...
      begin
         ...
         writeln('  6 = Direccion');
         writeln('  7 = Pago Online');
         writeln('  8 = Pago En Persona');
 ...
 procedure  reporteresultados;
  ...
  repeat
     ...
     writeln;
      writeln('  CODIGO DEL VENDEDOR    NOMBRE Y APELLIDO, Cedula ');
